...
from .schemes import TestCreate, TestWithoutQuestionsAndResult, TestResultCreate, TestResultInDB, TestInDB
from . import queries as qr

router = APIRouter(prefix="/tests")


@router.post("/", response_model=TestWithoutQuestionsAndResult, status_code=status.HTTP_201_CREATED)
